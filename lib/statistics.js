function stat(){
	...
	if (bigint_ok == 1 && transfer_ok == 1 && first_method_ok == 1 && table_ok == 1) {window.document.getElementById("statistics").innerHTML = window.document.getElementById("statistics").innerHTML + "> Libraries loaded successfully.<br>";} 
	else {window.document.getElementById("statistics").innerHTML = window.document.getElementById("statistics").innerHTML + "> Problem with loading of libraries!<br>";} //Libraries status check
